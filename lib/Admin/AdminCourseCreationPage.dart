...
import '../Courses/CourseSelectionPage.dart';
...
class _AdminCourseCreationPageState extends State<AdminCourseCreationPage>
  ...
  Future<void> _uploadThumbnail(String courseId) async {
    try {
      ...
      print("Thumbnail uploaded to $thumbnail");
    } catch (e) {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => CourseListPage(category: '', courseName: '', courses: [],),
          ),
        );
      } catch (e) {
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromARGB(255, 17, 1, 255),
                      padding:
